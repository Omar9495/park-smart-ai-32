      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex rounded-lg border border-ipark-gold/30 overflow-hidden shadow-md">
              {[1, 2, 3, 4].map(level => (
                <Button
                  key={level}
                  variant={activeLevel === level ? "default" : "ghost"}
                  className={cn(
                    "rounded-none px-8 py-6 text-lg",
                    activeLevel === level 
                      ? "bg-ipark-gold text-ipark-navy hover:bg-ipark-gold/90" 
                      : "text-ipark-navy hover:bg-ipark-gold/10"
                  )}
